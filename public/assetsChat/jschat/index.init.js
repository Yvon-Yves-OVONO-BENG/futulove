...
(function () {
  ...
  var url = window.location.origin + "/assets/js/dir1/";
  var usersList = "";
  var userChatId = 1;
  ...
  function toggleSelected() {
    ...
    console.log(userChatElement,"userChatElement")
    ...
    if (err !== null) {
      ...
      fav.forEach(function (user, index) {
        ...
        var isMessageCount = user.messagecount
          ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-reset rounded p-1">' + user.messagecount + "</span></div>"
          : "";
      ...
      users.forEach(function (userData, index) {
        ...
        var isMessageCount = userData.messagecount
          ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-reset rounded p-1">' + userData.messagecount + "</span></div>"
          : "";
      ...
      channelsData.forEach(function (isChannel, index) {
        var isMessage = isChannel.messagecount
          ? '<div class="flex-shrink-0 ms-2"><span class="badge bg-dark-subtle text-reset rounded p-1">' + isChannel.messagecount + "</span></div>"
          : "";
                ...
                ' + messageCount + ' \
                    <div class="d-flex align-items-center">\
                        <div class="flex-shrink-0 avatar-xs me-2">\
                            <span class="avatar-title rounded-circle bg-light-subtle text-reset">#</span>\
                        </div>\
                          ...
                          <div class="p-3 border-primary border rounded-3">\
                              <div class="d-flex align-items-center attached-file">\
                                  <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">\
                                      <div class="avatar-title bg-primary-subtle text-primary rounded-circle font-size-20"><i class="bx bx-headphone"></i></div>\
                                  </div>\
                                  <div class="flex-grow-1 overflow-hidden">\
